...
public class StateDatabaseBuilder
{
    ...
    public StateDatabaseBuilder(string path, string stateName)
    {
        this.path = path;
        this.stateName = stateName;
    }

    public StateDatabaseBuilder WithBinaryProperty(Hash hash, long originalSize, long? archivedSize = null, StorageTier? storageTier = null)
    {
    ...
    public StateDatabaseBuilder WithBinaryProperty(Hash hash, Hash parentHash, long originalSize, long? archivedSize = null, StorageTier? storageTier = null)
    {
        currentBinaryProperty = new BinaryPropertyData
        {
            Hash = hash,
    ...
    public StateDatabaseBuilder WithPointerFileEntry(string relativeName, DateTime? creationTime = null, DateTime? writeTime = null)
    {
