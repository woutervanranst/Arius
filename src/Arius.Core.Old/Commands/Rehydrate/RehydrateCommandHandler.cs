...
internal class RehydrateCommandHandler : AsyncCommand<RehydrateCommand>
{
    public RehydrateCommandHandler(ILogger<RehydrateCommandHandler> logger)
    {
        this.logger = logger;
    }

    private readonly ILogger<RehydrateCommandHandler> logger;

    protected override async Task<CommandResultStatus> ExecuteImplAsync(RehydrateCommand options)
    {
