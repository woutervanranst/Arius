...
internal record RestoreCommandOptions : RepositoryOptions
{
    public RestoreCommandOptions(RepositoryOptions options, DirectoryInfo root, bool synchronize, bool download, bool keepPointers, DateTime? pointInTimeUtc) : base(options)
    {
...
{
    public RestorePointerFileEntriesCommandOptions(RepositoryOptions options, DirectoryInfo root, bool download, bool keepPointers, DateTime pointInTimeUtc, params string[] relativeNames)
