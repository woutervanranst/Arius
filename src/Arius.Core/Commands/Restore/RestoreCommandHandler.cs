...
internal class RestoreCommandHandler : AsyncCommand<RestoreCommand>
{
    public RestoreCommandHandler(ILoggerFactory loggerFactory, Repository repo)
    {
        this.loggerFactory = loggerFactory;
        this.repo          = repo;
        this.logger        = loggerFactory.CreateLogger<RestoreCommandHandler>();
    }
    ...
    protected override async Task<CommandResultStatus> ExecuteImplAsync(RestoreCommand options)
    {
