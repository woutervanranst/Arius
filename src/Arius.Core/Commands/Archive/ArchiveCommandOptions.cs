...
internal record ArchiveCommandOptions : RepositoryOptions
{
    public ArchiveCommandOptions(RepositoryOptions options, DirectoryInfo root, bool fastHash, bool removeLocal, string tier, bool dedup, DateTime versionUtc) : base(options)
    {
    ...
    public ArchiveCommandOptions(string accountName, string accountKey, string containerName, string passphrase, DirectoryInfo root, bool fastHash, bool removeLocal, string tier, bool dedup, DateTime versionUtc) : base(accountName, accountKey, containerName, passphrase)
    {
        this.FastHash    = fastHash;
        this.RemoveLocal = removeLocal;
        this.Tier        = tier;
