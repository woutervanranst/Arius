...
internal class SHA256HasherTests
{
    ...
    public void HashingIsConsistent()
    {
        ...
        try
        {
            ...
            Assert.AreEqual(saltedHasher.GetBinaryHash(f).Value.BytesToHexString(), "4d801ce8f569d3f6c4acb2c6be4c2e0af4f8f30c102648651236cea267c723e2");

            Assert.AreEqual("wouter".CalculateSHA256Hash().BytesToHexString(), "791365155ba2b145691ca3c12c48d52f18b8a8afec7811c404d028f34a343454");
        }
        finally
        {
            File.Delete(f);
